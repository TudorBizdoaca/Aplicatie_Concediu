    ...
    public partial class InserareConcediu : Form
    {
        ...
        public async Task insertConcediuAsync()
        {
            ...
            //fa check inainte de inlocuitor id
                ...
                string URL = String.Format("{0}/InserareConcediu/esteAngajatInConcediu?id={1}&dataInceput={2}&dataFinal={3}", SesiuneLogIn.requestURL, c, StartDate.ToString(), EndDate.ToString());
