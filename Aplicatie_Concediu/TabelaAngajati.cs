...
namespace Aplicatie_Concediu
{
    ...
    {       
        ...
        public TabelaAngajati()
        {
            ...
            connection.Open();
            string query = "select a.nume, a.prenume,a.email, a.dataAngajare, a.dataNasterii, a.cnp, a.serie, a.no, a.nrTelefon, a.poza,a.esteAdmin, case when a.managerId IS NOT NULL then CONCAT(m.nume,' ',m.prenume) else 'No Manager' end as Manager, a.ZileConcediu from Angajat a\r\nleft join (select nume,prenume,id\r\nfrom Angajat ) m on m.id = a.managerId;\r\n";
